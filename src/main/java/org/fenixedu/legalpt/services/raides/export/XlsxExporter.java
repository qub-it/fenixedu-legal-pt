...
public class XlsxExporter {
        ...
        final SheetData<Registration> precedentDegreeInformationData = new SheetData<Registration>(raides.getAllRegistrations()) {
            ...
            protected void makeLine(final Registration registration) {
                ...
                addCell(pdiLabel("educationLevel"),
                        educationLevelLocalizedName(lastCompletedQualification.getEducationLevelType()));
                ...
                addCell(pdiLabel("precedentEducationLevel"), previousQualification != null ? educationLevelLocalizedName(
    ...
    protected static String educationLevelLocalizedName(final EducationLevelType educationLevelType) {
        return Optional.ofNullable(educationLevelType).map(EducationLevelType::getName).map(LocalizedString::getContent)
                .orElse("");
    }

    protected static String professionCategoryTypeLocalizedName(final ProfessionCategoryType professionCategoryType) {
        return Optional.ofNullable(professionCategoryType).map(ProfessionCategoryType::getName).map(LocalizedString::getContent)
                .orElse("");
    }

    protected static String professionalStatusTypeLocalizedName(final ProfessionalStatusType professionalStatusType) {
        return Optional.ofNullable(professionalStatusType).map(ProfessionalStatusType::getName).map(LocalizedString::getContent)
                .orElse("");
    }
}
